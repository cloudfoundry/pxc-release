...
func (fake *FakeCommandRunner) Run(arg1 string, arg2 ...string) ([]byte, error) {
	fake.runMutex.Lock()
...
func (fake *FakeCommandRunner) RunCalls(stub func(string, ...string) ([]byte, error)) {
	fake.runMutex.Lock()
...
var _ bpm_client.CommandRunner = new(FakeCommandRunner)
